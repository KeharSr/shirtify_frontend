...
import { Loader, ChevronRight, ChevronLeft, ShirtIcon } from 'lucide-react';
...
const ShortSleeves = () => {
  ...
  const fetchProducts = () => {
    setLoading(true);
    getProductsByCategoryApi('Short Sleeves', currentPage, limit)
      .then((res) => {
        if (res.status === 201) {
      ...
      <div className="container mx-auto px-4 py-12 pt-20 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
            Discover our collection of premium short sleeves that combine
            with your fashion.
          </p>
        </motion.div>
        ...
        {products.length === 0 ? (
          ...
          >
            <ShirtIcon className="w-24 h-24 text-indigo-400 mx-auto mb-6" />
            <h2 className="text-3xl font-semibold text-gray-700 mb-4">
              No short sleeves available at the moment
            </h2>
